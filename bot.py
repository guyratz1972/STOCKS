...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "run":
        await update.message.reply_text("Running report now...")
        await send_report("Manual Run")
    elif text == "help":
        ...
        await update.message.reply_text("Unknown command. Type 'run' to get a report.")
